...
<head>
    ...
    <meta name="description"
        content="Thăm khám và điều trị tại Phụ sản Tina với trải nghiệm dịch vụ chăm sóc sức khỏe 5* cùng đội ngũ chuyên gia hàng đầu.">
    ...
    <link rel="shortcut icon" href="{{asset("assets/images/logo-tina.png")}}" type="image/x-icon">
